...
if submitted:
    ...
    ########################################################
    st.markdown("***")
    colesp, col10, col11, col12, col13, col14 = st.columns([0.35, 0.2, 0.85, 0.85, 0.85, 0.5])
    with col10:
    ...
    #######################################################
    colesp, col20, col21, col22, col23, col24 = st.columns([0.35, 0.2, 0.85, 0.85, 0.85, 0.5])
    with col20:
